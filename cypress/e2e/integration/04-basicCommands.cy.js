...
describe("Cypress Selectors", () => {
    ...
    it('Dropdowns', () => {
        /**
         * If you want to handle the dropdown that is created using the <select> web element
         * You MUST use select() method from Cypress
         */
         ...
         * You have toy handleit as you habndle regular web cvomponents
         */
